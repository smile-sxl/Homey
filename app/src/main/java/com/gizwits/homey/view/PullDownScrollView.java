package com.gizwits.homey.view;
...
import com.gizwits.homey.utils.IPullDownElastic;
...
public class PullDownScrollView extends LinearLayout {
    ...
    private String note_release_to_refresh = getResources().getString(R.string.pull_to_refresh);
    private String note_pull_to_refresh = getResources().getString(R.string.release_to_refresh);
    private String note_refreshing = getResources().getString(R.string.refreshing);
